...
test_that("Multigroup, multimodel SEM works", {
  ...
  expect_equal_tables(indices, list("Comparative Fit Index (CFI)", 0.982526110332491, 0.985273769932234,
                                    0.9856692567613, "T-size CFI (CFI<unicode>)", 0.924962756454655,
                                    0.928335875530459, 0.928200402411451, "Tucker-Lewis Index (TLI)",
                                    0.972541030522486, 0.977809790308846, 0.979258134786093, "Bentler-Bonett Non-normed Fit Index (NNFI)",
  ...
  expect_equal_tables(others, list("Root mean square error of approximation (RMSEA)", 0.0681825681561195,
                                   ...
                                   0.39527626858524, "T-size RMSEA (RMSEA<unicode>)", 0.0867620686730192,
                                   0.0827529691159521, 0.0811263768098223, "Standardized root mean square residual (SRMR)",
