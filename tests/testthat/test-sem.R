...
test_that("Sensitivity parameters that led to a change in significance table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.401998712582474, -0.133707492109712, 0.839306883347651, "dem60~ind60",
...
test_that("Summary of sensitivity analysis table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.446712905437343, 0.817304450826043, 0.454361526415421, 0.10931250366198,
                                      "dem60~ind60", 1.54185610912183e-05, 0.397240001601392, 0.885228943292038,
                                      0.940534819295127, 0.889796135759017, 0.838319341744439, "dem65~dem60",
                                      0, "", 0.1822594099762, 0.335620470155876, 0.172277112909256,
                                      -0.13098545021451, "dem65~ind60", 0.00967602068670392, 0.125746805216113
                                 ))
})
...
test_that("Summary of sensitivity parameters table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.401998712582474, 0.113806982564325, -0.428828062076269, "dem60~phantom",
                                      0.21276746153651, -0.00984860889287902, -0.356128009622868,
                                      "dem65~phantom", 0.878781477259109, 0.249441092202601, -0.937148975256221,
                                      "ind60~phantom"))
})
