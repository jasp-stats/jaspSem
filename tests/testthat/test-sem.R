...
test_that("Regression coefficients table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.249609318439143, 0.447867133100656, 0.355178159312481, "x1",
                                      4.22839541158737e-12, "x2", 0.051257217293415, 6.92932972305757,
                                      -0.0367152972775892, 0.199977912531745, 0.0779182588187374,
                                      "x1", 0.152733811610159, "x3", 0.0544905222771874, 1.42994149372208,
                                      0.00301905807224417, 0.0567699557699217, 0.0306885890333796,
                                      "x1", 0.030672316061934, "y1", 0.0141991465135081, 2.16129814592621
                                 ))
})
...
test_that("Residual variances table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.0579281059892853, 0.121472726325043, "x1", 0.0973808537831693,
                                      "", "x1", 4.33176161607207e-10, 0.0156019586993568, 6.24157874403191,
