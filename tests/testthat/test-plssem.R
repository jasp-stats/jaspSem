...
test_that("cSEM example matches output", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.471353677923676, 0.285635055190257, "EXPE", "IMAG", 0.834448527558827,
                                      ...
                                      "VAL", "EXPE", 0.701315464456651, 0.330059801875975, "VAL",
                                      "QUAL", 0.244966114148237, 0.146153749343165, "SAT", "IMAG",
                                      -0.0172342465741804, 0.000378977922843456, "SAT", "EXPE", 0.221545357537628,
                                      0.0467867757143175, "SAT", "QUAL", 0.526952593892149, 0.437277523980573,
                                      "SAT", "VAL", 0.181941006626375, 0.0414081084059108, "LOY",
                                      "IMAG", 0.628293646783788, 0.493798244508887, "LOY", "SAT"
                                 ))
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.0156437093210086, "IMAG", "imag1", 0.44728617775625, "IMAG",
                                      "imag2", 0.602044065350609, "IMAG", "imag3", 0.294610643934218,
                                      "EXPE", "expe1", 0.647338185763638, "EXPE", "expe2", 0.23737441876182,
                                      "EXPE", "expe3", 0.237038612241018, "QUAL", "qual1", 0.471225085890941,
                                      "QUAL", "qual2", 0.183069588476778, "QUAL", "qual3", 0.10372504473348,
                                      "QUAL", "qual4", 0.204858416371178, "QUAL", "qual5", 0.716330223392201,
                                      "VAL", "val1", 0.220214717332445, "VAL", "val2", 0.208155654302742,
                                      "VAL", "val3", 0.320857337027855, "SAT", "sat1", 0.305946708478931,
                                      "SAT", "sat2", 0.247415822628863, "SAT", "sat3", 0.269239802888533,
  ...
  jaspTools::expect_equal_tables(table,
                                 list("SAT", 0.905102486354131, 0.895998833388936, 0.894010912676559,
                                      "LOY", 0.876110242219458, 0.823701924294241, 0.819421641029961
                                 ))

  table <- results[["results"]][["modelContainer"]][["collection"]][["modelContainer_tabrsquared"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list("EXPE", 0.219037895698999, 0.222174289692176, "QUAL", 0.695079765891647,
                                      0.696304345145095, "VAL", 0.543779108936317, 0.547443533764138,
                                      "SAT", 0.758514799820926, 0.762394080145088, "LOY", 0.583411462155354,
                                      0.586757554828805))
  })
